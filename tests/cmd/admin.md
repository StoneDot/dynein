...
dy-admin-create-table 0.2.1
Create new DynamoDB table with given primary key(s). [API: CreateTable]

USAGE:
    dy admin create table [OPTIONS] <new-table-name> --keys <keys>...
...
dy-admin-delete 0.2.1
Delete a DynamoDB table or GSI. [API: DeleteTable]

USAGE:
    dy admin delete [OPTIONS] <SUBCOMMAND>
...
dy-admin-delete-table 0.2.1
Delete a DynamoDB table

USAGE:
    dy admin delete table [FLAGS] [OPTIONS] <table-name-to-delete>
...
USAGE:
    dy admin desc [FLAGS] [OPTIONS] [target-table-to-desc]
...
USAGE:
    dy admin update [OPTIONS] <SUBCOMMAND>
...
dy-admin-update-table 0.2.1
Update a DynamoDB table

USAGE:
    dy admin update table [OPTIONS] <table-name-to-update>
